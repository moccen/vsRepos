/**
 * 
 * @authors tony Lee (you@example.org)
 * @date    2014-11-18 21:57:17
 * @version $Id$
 */
...
function getBarChart(dataArray, metaData) {
    ...
    var myOptions = {
        chart: {
            ...
            plotShadow: false,
            //width: $('.pvtRendererArea').width() //by TL
            //width: $('.pivottable-master').height() * 0.8,//by TL
            //height: ($('.pivottable-master').width() * 0.9) - 150 //by TL
            width: $('#regioncenter').width() - 150 > 0 ? $('#regioncenter').width() - 200 : 1024,//by TL
            height: $('#regioncenter').height() - 150 > 0 ? $('#regioncenter').height() - 200 : 640  //by TL
...
function getBoxPlot(dataArray, metaData) {
    ...
    var myOptions = {
        chart: {
            ...
            type: 'boxplot',
            //width: $('.pvtRendererArea').width() //by TL
            //width: ($('.pivottable-master').width() * 0.9) - 150,//by TL
            //height: $('.pivottable-master').height() * 0.8 //by TL
            width: $('#regioncenter').width() - 150 > 0 ? $('#regioncenter').width() - 200 : 1024,//by TL
            height: $('#regioncenter').height() - 150 > 0 ? $('#regioncenter').height() - 200 : 640  //by TL
