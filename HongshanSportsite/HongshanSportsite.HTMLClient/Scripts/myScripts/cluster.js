...
(function () {
     ...
     *
     * @return {Number} 如果在数组内，返回索引，否则返回-
     */
    ...
    var MarkerClusterer =
         ...
         *    girdSize {Number} 聚合计算时网格的像素大小，默认<br />
         *    maxZoom {Number} 最大的聚合级别，大于该级别就不进行相应的聚合<br />
         *    minClusterSize {Number} 最小的聚合数量，小于该数量的不能成为一个聚合，默认为<br />
    ...
    /**
    * 在创建完所有的cluster后再将cluster 更新一下 ,by tony lee   
    * @return 无返回值
    */
    MarkerClusterer.prototype._updateClusters = function () {
    ...
    Cluster.prototype.addMarker = function (marker) {
        ...
        this._map.addOverlay(this._clusterMarker);
        this._isReal = true;
        //this.updateClusterMarker();每加一个marker就刷新一次cluster效率低下？tony
        return true;
    };
